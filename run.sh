...
# sleep 10
# python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 21600 1 pidstat10.json 1
# killall -9 python3
# mkdir -p 10
...
# sleep 10
# python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 21600 1 pidstat11.json 1
# killall -9 python3
# mkdir -p 11
...
# sleep 10
# python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 21600 1 pidstat14.json 1
# killall -9 python3
# mkdir -p 14
...
#sleep 10
#python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 86400 1 pidstat142.json 1
#killall -9 python3
#mkdir -p 14.2
...
sleep 10
python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 43200 1 pidstat17.json 1
killall -9 python3
mkdir -p 17
...
python3 -u run_official_sim.py 10 > 10.out 2> 10.err &
sleep 10
python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 43200 1 pidstat10.json 1
killall -9 python3
mkdir -p 10
mv *.json *.gv *.pdf *.out *.err *.prof 10
...
python3 -u run_official_sim.py 11 > 11.out 2> 11.err &
sleep 10
python /home/marco/Dokumente_git/masterarbeit/code/pidstat_parse.py python3 43200 1 pidstat11.json 1
killall -9 python3
mkdir -p 11
mv *.json *.gv *.pdf *.out *.err *.prof 11
